...
const ContactsSection = () => {
  return (
    <Section id="contacts">
      ...
      <MainContainer className="flex flex-col gap-[60px] bg-[#141414] max-w-[450px] items-center pt-4 pb-9 md:pt-[80px] md:max-w-full lg:flex-row lg:py-[50px] lg:items-start lg:gap-[130px]">
